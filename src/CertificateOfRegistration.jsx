...
const CertificateOfRegistration = () => {
  const [studentInfo, setStudentInfo] = useState({
    studentNo: '234-03163M',
    name: 'PANES, CLYDE LAWRENCE',
  ...
  const [subjects, setSubjects] = useState([
    ...
    const [fees, setFees] = useState({
      ...
      guidanceFee: '30.00',
      libraryFee: '100.00',
      medicalDentalFee: '150.00',
      registrationFee: '130.00',
      computerFee: '500',
      totalAssessment: '2,900.00',
      lessFinancialAid: '2,900.00',
      netAssessed: '0.00',
      creditMemo: '0.00',
      totalDiscount: '0.00',
      totalPayment: '0.00',
        ...
        {Object.entries(fees).map(([key, value]) => (
          <tr key={key}>
            ...
            <td style={{
              ...
              <table
                ...
                <div style={{
                    ...
                    <div>
                      <strong>February 24, 2025__________ </strong> 
                    </div>
            ...
            <div style={{
                ...
                />
                <div style={{ fontSize: '8px', marginTop: '4px' }}>02 24, 2025 02:30:45 PM</div>
                </div>
            </div>
